...
import { AddStrainForm } from "./strains/form/add-strain-form";
import {
  createStrainSchema,
  StrainFormValues,
} from "./strains/form/add-strain.schema";
import { StrainGallerySkeleton } from "./strains/skeletons/strain-gallery-skeleton";
import { StrainCard } from "./strains/strain-card";
import {
  FloweringType,
  SelectedStrain,
  StrainType,
...
export function AddPlantsStep({
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      const strains = await apiRequest<Strain[]>("/api/strains");
      return strains.map((strain) => ({
        ...strain,
        cannabinoidProfile: strain.cannabinoidProfile as
